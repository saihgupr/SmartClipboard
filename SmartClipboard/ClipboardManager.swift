...
class ClipboardManager: ObservableObject {
    ...
    func checkForChanges() {
        ...
        if let newString = pasteboard.string(forType: .string), !newString.isEmpty {
            // Security: Prevent DoS by ignoring excessively large clipboard items
            guard newString.utf8.count <= 100_000 else {
                print("Ignored clipboard item: content exceeds maximum length limit")
                return
            }
