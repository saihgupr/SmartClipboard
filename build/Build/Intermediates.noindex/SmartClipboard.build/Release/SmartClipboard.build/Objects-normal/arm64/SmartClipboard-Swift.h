...
#ifndef SMARTCLIPBOARD_SWIFT_H
#define SMARTCLIPBOARD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SmartClipboard",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14SmartClipboard20MenuItemActionTarget")
...
@class NSEvent;
@class NSCoder;
SWIFT_CLASS("_TtC14SmartClipboard20MouseDetectingNSView")
@interface MouseDetectingNSView : NSView
...
SWIFT_CLASS("_TtC14SmartClipboard13ShareDelegate")
